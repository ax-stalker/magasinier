        ...
        <div class="col-md-6 col-sm-8">
            <form method="POST" action="">
                <div class="form-group mb-4">
                    <input type="text" class="form-control" id="studentNumber" name="studentNumber" placeholder="Please enter Student Number">
                </div>
                <div class="text-center">
...
if (isset($_POST['search'])) {
    ...
    if ($result->num_rows > 0) {
                ...
                <div class="col-md-6 col-sm-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="issue.php" class="btn btn-success">Issue Out</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        // Student not found
        echo '<div class="container mt-4 col-md-6 col-sm-8"><div class="alert alert-danger">Student not found.</div></div>';
    }
